...
@Getter @Builder
public class CustomRecipeArticlesResponse {
    ...
    public static CustomRecipeArticlesResponse from(Long totalCount, Long totalPage, Long currentPage, List<Article> articles) {
        return CustomRecipeArticlesResponse.builder()
